...
import "./delivery-executive-create.scss";
...
class DeliveryExecutiveViewPage extends React.Component {
      ...
      <div className="ListCategoriesContent">
        <div className="card">
          <div className="card-body">
            <div className="PageTitle">Delivery Executive View</div>
...
export default connect(mapStateToProps, mapDispatchToProps)(DeliveryExecutiveViewPage);
