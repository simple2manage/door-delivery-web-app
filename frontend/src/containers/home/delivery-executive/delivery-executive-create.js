...
class DeliveryExecutiveCreatePage extends React.Component {
      ...
      <div className="LoginFormInnerContainer">
        <div className="card">
          <div className="card-body">
            <div className="PageTitle">{this.state.query === "" ? "Add Delivery Executive" : "Update Delivery Executive"}</div>
