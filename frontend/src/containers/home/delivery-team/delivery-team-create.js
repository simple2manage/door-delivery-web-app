...
class DeliveryTeamCreatePage extends React.Component {
      ...
      <div className="LoginFormInnerContainer">
        <div className="card">
          <div className="card-body">
            <div className="PageTitle">{this.state.query === "" ? "Add Delivery Team" : "Update Delivery Team"}</div>
                ...
                <div className="row">
                  <div className="col-12 col-sm-6 col-md-6 col-lg-6 col-xl-6 mb-4">
                    ...
                    <div className="CategoriesViewProfile">
                      ...
                      >
                        {photo.length > 0 ? null : uploadButton}
                      </Upload>
                      {/* :''} */}
