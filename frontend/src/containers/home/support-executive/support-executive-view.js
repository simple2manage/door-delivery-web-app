...
class SupportExecutiveViewPage extends React.Component {
      ...
      <div className="ListCategoriesContent">
        <div className="card">
          <div className="card-body">
            <div className="PageTitle">Support Executive View</div>
...
export default connect(mapStateToProps, mapDispatchToProps)(SupportExecutiveViewPage);
